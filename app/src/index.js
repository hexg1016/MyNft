...
const App = {
  ...
  start: async function() {
    ...
    try {
      ...
      const deployedNetwork = myTokenArtifact.networks[networkId];
  ...
  refreshBalance: async function() {
    ...
    const result = await this.meta.methods.allowance(this.account,"0xf288E7f6aC0026bD4Cb90dB4c9fa9573DFC2E814").call();
